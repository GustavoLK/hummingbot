...
class SimplePositionV2Config(StrategyV2ConfigBase):
...
class SimplePositionV2(StrategyV2Base):
    account_config_set = False
    can_enter_position = True
    signal_file = '/tmp/hummingbot_simple_position'
    last_action_timestamp = None

    def __init__(self, connectors: Dict[str, ConnectorBase], config: SimplePositionV2Config):
